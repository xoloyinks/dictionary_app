  ...
  return (
    <>
      <section className='relative w-screen h-screen'>
        ...
        <div onClick={favVisibility}  className="`w-fit absolute right-5 bottom-16 sm:bottom-2 p-2 rounded-md sm:text-4xl text-xl hover:scale-110 active:scale-100 duration-200 bg-slate-200 dark:bg-[#212933] z-50 flex items-center">
        ...
        <div className={`absolute ${visibility} right-0 z-40 px-5 py-4 text-sm sm:bottom-16 bottom-24 dark:bg-slate-100/75 bg-gray-700/75 dark:text-black  text-white rounded-l-2xl`}>
